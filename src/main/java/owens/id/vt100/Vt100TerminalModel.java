...
import owens.id.AbstractTerminalModel;
import owens.id.TerminalCell;
import owens.id.TerminalModel;
import owens.id.bell.BellStrategy;
import owens.id.bell.NopBellStrategy;


public class Vt100TerminalModel extends AbstractTerminalModel {                   // mvn test-compile org.pitest:pitest-maven:mutationCoverage
